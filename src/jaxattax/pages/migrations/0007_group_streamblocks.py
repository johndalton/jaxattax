...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='homepage',
            name='body',
            field=wagtail.core.fields.StreamField([('rich_content', wagtail.core.blocks.StreamBlock([('heading', wagtail.core.blocks.CharBlock(group=jaxattax.blocks.Group(name='Text', order=100), icon='fa-header')), ('subheading', wagtail.core.blocks.CharBlock(group=jaxattax.blocks.Group(name='Text', order=100), icon='fa-header')), ('rich_text', wagtail.core.blocks.RichTextBlock(features=['bold', 'italic', 'link', 'document-link', 'ol', 'ul', 'hr', 'embed'], group=jaxattax.blocks.Group(name='Text', order=100), label='Text')), ('hero_text', wagtail.core.blocks.RichTextBlock(features=['bold', 'italic', 'link', 'document-link', 'ol', 'ul', 'hr', 'embed'], group=jaxattax.blocks.Group(name='Big and bold', order=200), help_text='Big and bold, use for important text at the start of a page.', label='Hero text')), ('hero_image', wagtail.images.blocks.ImageChooserBlock(group=jaxattax.blocks.Group(name='Big and bold', order=200), help_text='Big image, use as the feature image of a page.', label='Hero image')), ('buttons', wagtail.core.blocks.ListBlock(wagtail.core.blocks.StructBlock([('text', wagtail.core.blocks.CharBlock()), ('link', wagtail.core.blocks.StructBlock([('page', wagtail.core.blocks.PageChooserBlock()), ('document', wagtail.documents.blocks.DocumentChooserBlock())]))]))), ('captioned_image', wagtail.core.blocks.StructBlock([('image', wagtail.images.blocks.ImageChooserBlock()), ('alignment', wagtail.core.blocks.ChoiceBlock(choices=[('full-width', 'Full width'), ('left', 'Left'), ('right', 'Right')])), ('caption', wagtail.core.blocks.RichTextBlock(features=['bold', 'italic', 'link', 'document-link'], help_text='Some short text describing the image', required=False))])), ('side_image', wagtail.core.blocks.StructBlock([('image', wagtail.images.blocks.ImageChooserBlock()), ('alignment', wagtail.core.blocks.ChoiceBlock(choices=[('left', 'Left'), ('right', 'Right')])), ('content', wagtail.core.blocks.StreamBlock([('heading', wagtail.core.blocks.CharBlock(group=jaxattax.blocks.Group(name='Text', order=100), icon='fa-header')), ('subheading', wagtail.core.blocks.CharBlock(group=jaxattax.blocks.Group(name='Text', order=100), icon='fa-header')), ('rich_text', wagtail.core.blocks.RichTextBlock(features=['bold', 'italic', 'link', 'document-link', 'ol', 'ul', 'hr', 'embed'], group=jaxattax.blocks.Group(name='Text', order=100), label='Text'))]))])), ('table_of_contents', wagtail.core.blocks.StructBlock([])), ('cash_donations', wagtail.core.blocks.StructBlock([]))])), ('calls_to_action', wagtail.core.blocks.ListBlock(wagtail.core.blocks.StructBlock([('heading', wagtail.core.blocks.CharBlock()), ('image', wagtail.images.blocks.ImageChooserBlock(blank=True)), ('content', wagtail.core.blocks.RichTextBlock(features=['bold', 'italic', 'link', 'document-link'])), ('link', wagtail.core.blocks.PageChooserBlock()), ('call_to_action', wagtail.core.blocks.CharBlock())])))]),
        ),
        migrations.AlterField(
            model_name='page',
            name='body',
